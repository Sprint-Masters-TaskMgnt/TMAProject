    ...
    public partial class firsttask : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskTbls", x => x.TaskId);
                    table.ForeignKey(
                        name: "FK_TaskTbls_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "ProjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskTbls_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTbls_ProjectId",
                table: "TaskTbls",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskTbls_UserId",
                table: "TaskTbls",
                column: "UserId");
